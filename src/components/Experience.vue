...
<template>
  <div class="relative w-full mb-6">
    ...
    <div class="ml-6">
      <div class="flex" :class="[experience.industry || experience.project? 'mb-0' : 'mb-4']">
        <div class="font-black">
          {{ experience.title }}
          <template v-if="!experience.grouped"> @ {{ experience.company }}</template>
        </div>
        <template v-if="!experience.grouped">
          <div class="grow border-b border-black dark:border-gray-200 mb-3 ml-1"></div>
      ...
      <div v-if="experience.industry" :class="experience.project ? '' : 'mb-4'">
    ...
    <img v-if="experience.image" class="transition transition-all ease-in-out delay-150 brightness-50 h-6 hover:h-64 w-full mx-auto object-cover" :src="`/src/assets/${experience.image}`" alt="work experience footer image">
  </div>
