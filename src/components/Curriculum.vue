...
// Refs
const highContrast = ref('text-black dark:text-white border-black dark:border-white');
  ...
  <div class="container m-auto text-xs" :style="isPrintable ? 'width: 297mm' : '' ">
    ...
    <div v-if="!isPrintable">
      <div class="text-center">
        <div
            class="w-full group min-w-0 mt-20 break-words border rounded-md shadow-md"
    ...
    <div class="grid grid-cols-12 bg-white dark:bg-inherit mt-2">
      <div class="left-column">
        <!-- isPrintable header -->
        <section v-if="isPrintable" class="pt-0" :class="props.theme == 'high-contrast' ? highContrast : normal" >
          ...
          <div v-if="!isPrintable" class="flex flex-wrap justify-center">
            <div class="flex justify-center w-full">
              <div class="relative">
                <img src="../assets/images/profile-image-1.png"
                     class="dark:shadow-xl rounded-full align-middle border-4 max-w-[150px]"
                     :class="props.theme == 'high-contrast' ? highContrast : normal"
                     alt="profile image"
                />
              </div>
          ...
          <div class="mt-4 text-center" :class="isPrintable ? 'text-xs':''">
            <h1>Jonathan Ruiz</h1>
            <h2>Software Engineer</h2>
            <span class="inline-block">
              <a href="http://jonathanruiz.co.uk" class="text-inherit">jonathanruiz.co.uk</a>
            </span>
            <span class="inline-block">
            +44 (0)7754 218 610
            </span>
