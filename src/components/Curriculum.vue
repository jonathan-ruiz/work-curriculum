...
// Refs
const highContrast = ref('text-black dark:text-white border-black dark:border-white bg-white dark:bg-black');
const normal = ref('text-gray-800 dark:text-gray-100 border-gray-800 dark:border-gray-100 bg-gray-100 dark:bg-gray-800');


const isPrintable = computed(
    () => props.version === 'printable'
)
console.log(skillsFromExperience)

</script>

<template>
  <div class="container m-auto" :style="isPrintable ? 'width: 297mm' : '' ">
    <!-- Online Header    -->
    <div v-if="!isPrintable">
      <div class="text-center">
        <div
            class="w-full group min-w-0 mt-20 break-words bg-white  border rounded-md shadow-md"
            :class="props.theme == 'high-contrast' ? highContrast : normal">
          <div class="pb-6">
            <div class="flex flex-wrap justify-center">
              <div class="flex justify-center w-full">
                <div class="relative">
                  <img src="../assets/images/profile-image-1.png"
                       class="align-middle border-8 absolute -m-16 -ml-18 lg:-ml-16 max-w-[150px]"
                       :class="props.theme == 'high-contrast' ? highContrast : normal"
                       alt="profile image"
                  />
                </div>
              ...
              <div class="w-full text-center">
                <div class="flex justify-center pt-8 pb-0 lg:pt-4">
                  <div class="flex space-x-2">
                    <a
                        class="p-1 -m-1 hover:text-amber-500 focus:outline-none focus-visible:ring-2 ring-primary"
                        :class="props.theme == 'high-contrast' ? highContrast : normal"
                        href="https://twitter.com/jonathan_ruiz3"
                        rel="noopener"
                        aria-label="Jonathan Ruiz on Twitter"
                        target="_blank"
                    >
                      <svg class="w-6 overflow-visible fill-current" aria-hidden="true" viewBox="0 0 140 140">
                        <path
                    ...
                    <a class="p-1 -m-1 hover:text-amber-500 focus:outline-none focus-visible:ring-2 ring-primary"
                       :class="props.theme == 'high-contrast' ? highContrast : normal"
                       href="https://github.com/jonathan-ruiz" rel="noopener" aria-label="Jonathan Ruiz on Github"
                       target="_blank">
                      <svg class="w-6 h-6 overflow-visible fill-current" aria-hidden="true"
                           viewBox="0 0 140 140">
                        <path
                    ...
                    <a
                        class="p-1 -m-1 hover:text-amber-500 focus:outline-none focus-visible:ring-2 ring-primary"
                        :class="props.theme == 'high-contrast' ? highContrast : normal"
                        href="https://www.linkedin.com/in/jonathanruizx"
                        rel="noopener"
                        aria-label="Jonathan Ruiz on Linkedin"
                        target="_blank"
                    >
                      <svg class="w-6 h-6 overflow-visible fill-current" aria-hidden="true"
                           viewBox="0 0 140 140">
                    ...
                    <a
                        class="p-1 -m-1 hover:text-amber-500 focus:outline-none focus-visible:ring-2 ring-primary"
                        :class="props.theme == 'high-contrast' ? highContrast : normal"
                        href="https://www.youtube.com/@jonathanruiz3"
                        rel="noopener"
                        aria-label="Jonathan Ruiz on Youtube"
                        target="_blank"
                    >
                      <svg class="w-6 h-6 overflow-visible fill-current" aria-hidden="true"
                           viewBox="0 0 140 140">
            ...
            <div class="pt-6 mx-6 mt-6 text-left border-t"
                 :class="props.theme == 'high-contrast' ? highContrast : normal">
              <div class="flex flex-wrap justify-center">
                <div class="w-full px-6">
                  <p>
                    ...
                    have over
                    20 years of experience in software engineering, spanning different roles, technologies and
                    platforms. I enjoy
                    learning new skills and paradigms, and adapting to changing environments and requirements.
                  </p>
                  <p>
                    I have also led teams of up to 9 people, and worked on my own products from ideation to production.
                    I have a
                    strong background in web development, devOps and cloud. My goal is to deliver reliable, scalable and
                    user-friendly solutions that meet the needs and expectations of my team and users.
                  </p>
                </div>
              </div>
            </div>
          </div>
          <div class="bg-black dark:bg-white py-2">
    ...
    <div class="grid grid-cols-12 bg-white dark:bg-inherit mt-2">
      <div class="left-column">
        <!-- isPrintable header -->
        <section :class="props.theme == 'high-contrast' ? highContrast : normal" v-if="isPrintable">
          <template>
            <!-- isPrintable header profile picture -->
            <div v-if="!isPrintable" class="flex flex-wrap justify-center">
              <div class="flex justify-center w-full">
                <div class="relative">
                  <img src="../assets/images/profile-image-1.png"
                       class="dark:shadow-xl rounded-full align-middle border-8 max-w-[150px]"
                       :class="props.theme == 'high-contrast' ? highContrast : normal"
                       alt="profile image"
                  />
                </div>
        ...
        <section>
          <h2>
            <TrophyIcon class="w-6 inline-block"/>
            Awards & Patents
          </h2>
          <ul>
            <li>
              <h3>1st Place - University UJI of Castellon - Sumobot 2008</h3>
            </li>
            <li>
              <h3>2nd Place - University UJI of Castellon - Web application development 2007</h3>
            </li>
            <li>
              <h3>
                <a href="https://courses.edx.org/certificates/457be78e0c8947fb8305c38ad353000b">Web Accessibility</a>:
                https://courses.edx.org/certificates/457be78e0c8947fb8305c38ad353000b</h3>
            </li>

            <li>
              <h3>
                <a href="https://www.patentguru.com/inventor/ruiz-peinado-jonathan">Patents</a>:
                https://www.patentguru.com/inventor/ruiz-peinado-jonathan
              </h3>
            </li>
      ...
      <div class="right-column">
        <!-- isPrintable summary  -->
        <div v-if="isPrintable" class="border-0">
