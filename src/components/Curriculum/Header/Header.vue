  ...
  <div v-bind="attrs" :class="['', attrs.class]">
    ...
    >
      ...
      <div class="bg-black dark:bg-white py-2 text-white dark:text-black">
        ...
        <span class="block md:inline">contact@jonathanruiz.co.uk</span>
        <span class="print:hidden hidden md:inline mx-1">|</span>
        <span class="print:hidden block md:inline">
          <KeyIcon class="w-4 inline-block" />
          Public Key
          <a href="/id_rsa.pub" class="text-inherit hover:underline">HERE</a>
        </span>
        <span class="print:hidden hidden md:inline mx-1">|</span>
        ...
        <div class="print:hidden text-center inline-block">
          <div class="flex justify-center pb-0">
            <div class="flex space-x-2">
              <a
                  class="p-1 -m-1 hover:text-amber-500 focus:outline-none focus-visible:ring-2 ring-primary text-white dark:text-black"
              ...
              >
                <svg
                    class="w-4 overflow-visible fill-current"
                    aria-hidden="true"
                    viewBox="0 -70 140 140"
                >
                  <path
              ...
              <a
                  class="p-1 -m-1 hover:text-amber-500 focus:outline-none focus-visible:ring-2 ring-primary text-white dark:text-black"
                  href="https://github.com/jonathan-ruiz"
                  rel="noopener"
                  aria-label="Jonathan Ruiz on Github"
                  target="_blank"
              >
                <svg
                    class="w-4 overflow-visible fill-current"
